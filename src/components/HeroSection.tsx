...
import { trackTelegramChannel, trackTelegramBot, trackTwitter } from '@/lib/analytics';
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6">
          ...
          <br />
          <span className="text-white">Copy Trading Signals</span>
        </h1>

        {/* Subheadline */}
        <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-8">
          Verified performance. Transparent results.
          <br />
          Start copying our GoldenBull signal on Pepperstone today.
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-8 mb-12">
          ...
          <div className="glass rounded-xl px-6 py-4 hover-lift">
            ...
            <div className="text-gray-400 text-sm">Broker</div>
          </div>
        </div>
        ...
        >
          <span>Start copying directly via Telegram Bot →</span>
        </a>
      </div>
